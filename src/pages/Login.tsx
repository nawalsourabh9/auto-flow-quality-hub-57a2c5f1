...
const Login = () => {
  ...
  return <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 dark:bg-gray-900">
      <Card className="mx-auto w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            {debugInfo && <div className="p-3 text-xs bg-gray-100 rounded overflow-auto max-h-32">
