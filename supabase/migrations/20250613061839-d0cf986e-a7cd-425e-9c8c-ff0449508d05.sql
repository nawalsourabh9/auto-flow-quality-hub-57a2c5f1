...
-- Fix the days_since_completion calculation in generate_next_recurring_task function
...
DECLARE
 ...
 BEGIN
   ...
   -- FIX: Calculate days since the completed task's start date using EXTRACT to get INTEGER
