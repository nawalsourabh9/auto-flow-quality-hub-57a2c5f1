-- Fix the "invalid input syntax for type integer: '3 days'" error
-- This replaces the incorrect days_since_completion calculation
...
BEGIN
  ...
  -- FIX: Calculate days since the completed task's start date (ensure INTEGER result)
